...
if __name__ == '__main__':
    ...
    #detected_balls = detect.run_optimised_for_ball(source="training_data/data/images/test/",weights="trained_data/latest_/weights/last.pt",imgsz=(416),conf_thres=(0.5),save_txt=True,project="./ball_output")  
    # print(json_)
    #detected_goals = GoalDetection.detect_goals_from_json(detected_balls)
    #requestHandler.send_goals(deteced_goals,cam=4)
